...
################################################################################
#  Soubor:    testParallelLangtonCell.sh                                       #
#  Autor:     Radim KUBIŠ, xkubis03                                            #
#  Vytvořeno: 8. května 2014                                                   #
#                                                                              #
#  Projekt do předmětu Biologií inspirované počítače (BIN).                    #
#                                                                              #
#  SKRIPT SPOUŠTÍ SADU TESTŮ PARALELNÍHO (BUNĚČNÉHO) VÝPOČTU CA LANGTONOVY     #
#  SMYČKY                                                                      #
#                                                                              #
...
do
    ...
    do
        ...
        mpiexec -n $processors ./parallelLangtonCell.py $actual_size $steps_of_ca
    done
