...
################################################################################
#  Soubor:    testParallelBylBlockRow.sh                                       #
#  Autor:     Radim KUBIŠ, xkubis03                                            #
#  Vytvořeno: 26. dubna 2014                                                   #
#                                                                              #
#  Projekt do předmětu Biologií inspirované počítače (BIN).                    #
#                                                                              #
#  SKRIPT SPOUŠTÍ SADU TESTŮ PARALELNÍHO (BLOKOVÉHO) VÝPOČTU CA BYLOVY SMYČKY  #
#                                                                              #
...
do
    ...
    do
        ...
        mpiexec -n $processors ./parallelBylBlockRow.py $actual_size $steps_of_ca
    done
