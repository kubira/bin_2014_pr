...
if rank == 0:
    ...
    for step in range(0, STEPS_OF_CA):
        ...
        for rowIndex in range(0, numberOfRows):
            ...
            fieldB[rowIndex] = comm.recv(fieldB[rowIndex], source=MPI.ANY_SOURCE, tag=rowIndex)
    ...
    for step in range(0, STEPS_OF_CA):
        ...
        while rowIndex < numberOfRows:
            ...
            for colIndex in range(0, numberOfCols):
                ...
                newRowValues.append(getNewLifeValue(fieldCA, rowIndex, colIndex, numberOfCols, numberOfRows))
