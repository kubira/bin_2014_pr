...
if rank == 0:
    ...
    for step in range(0, STEPS_OF_CA):
        ...
        while cellIndex < (numberOfRows*numberOfCols):
            ...
            newCell = getNewLangtonLoopValue(fieldCA, rowIndex, colIndex, numberOfCols, numberOfRows)
