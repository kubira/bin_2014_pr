...
if rank == 0:
    ...
    # Nastavení posunu na další buňku
    ...
    for step in range(0, STEPS_OF_CA):
        ...
        while cellIndex < (numberOfRows*numberOfCols):
            ...
            newCell = getNewLifeValue(fieldCA, rowIndex, colIndex, numberOfCols, numberOfRows)

            # Odeslání nové buňky root procesoru
            comm.send(newCell, dest=0, tag=cellIndex)

            # Posun na další buňku ke zpracování
            cellIndex += increment
