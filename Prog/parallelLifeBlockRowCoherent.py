    ...
    for step in range(0, STEPS_OF_CA):
        ...
        while rowIndex < indexTo:
            ...
            for colIndex in range(0, numberOfCols):
                ...
                fieldY[rowIndex][colIndex] = getNewLifeValue(fieldX, rowIndex, colIndex, numberOfCols, numberOfRows)
