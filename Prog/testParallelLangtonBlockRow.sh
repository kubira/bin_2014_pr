...
################################################################################
#  Soubor:    testParallelLangtonBlockRow.sh                                   #
#  Autor:     Radim KUBIŠ, xkubis03                                            #
#  Vytvořeno: 25. dubna 2014                                                   #
#                                                                              #
#  Projekt do předmětu Biologií inspirované počítače (BIN).                    #
#                                                                              #
#  SKRIPT SPOUŠTÍ SADU TESTŮ PARALELNÍHO (BLOKOVÉHO) VÝPOČTU CA LANGTONOVY     #
#  SMYČKY                                                                      #
#                                                                              #
...
do
    ...
    do
        ...
        mpiexec -n $processors ./parallelLangtonBlockRow.py $actual_size $steps_of_ca
    done
