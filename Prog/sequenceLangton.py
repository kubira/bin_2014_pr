...
################################################################################
#  Soubor:    sequenceLangton.py                                               #
#  Autor:     Radim KUBIŠ, xkubis03                                            #
#  Vytvořeno: 24. dubna 2014                                                   #
#                                                                              #
#  Projekt do předmětu Biologií inspirované počítače (BIN).                    #
#                                                                              #
#  SEKVENČNÍ VÝPOČET CA LANGTONOVY SMYČKY                                      #
#                                                                              #
...
for step in range(0, STEPS_OF_CA):
    ...
    for row in range(0, numberOfRows):
        ...
        for col in range(0, numberOfCols):
            ...
            fieldB[row][col] = getNewLangtonLoopValue(fieldA, row, col, numberOfCols, numberOfRows)
