...
################################################################################
#  Soubor:    testParallelLifeOneRow.sh                                        #
#  Autor:     Radim KUBIŠ, xkubis03                                            #
#  Vytvořeno: 22. dubna 2014                                                   #
#                                                                              #
#  Projekt do předmětu Biologií inspirované počítače (BIN).                    #
#                                                                              #
#  SKRIPT SPOUŠTÍ SADU TESTŮ PARALELNÍHO (JEDNOŘÁDKOVÉHO) VÝPOČTU CA HRY LIFE  #
#                                                                              #
...
do
    ...
    do
        ...
        mpiexec -n $processors ./parallelLifeOneRow.py $actual_size $steps_of_ca
    done
